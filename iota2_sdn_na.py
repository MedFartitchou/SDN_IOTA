...
# add controller 1          :   0x45191aa30986B3207C42102787f14f896AFB5554 by IPS
# add Switch 1              :   0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 by IPS
# add switch 2              :   0xE422568F3C95990E5F58BE87B27F0804017b8697 by IPS
# add switch 3              :   0x73C964F73738931B54686bF02E6Cc774f2Db44e8 by IPS
# add addStandbyController  :   0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC by IPS
# add controller 2          :   0x18fD9C5C28d0cB57Bb82950dE0ba6d3aB946EA9f by IPS
...
web3 = Web3(Web3.HTTPProvider("https://json-rpc.evm.testnet.shimmer.network"))
chain_id = 1073
def check_certificate_validity():
    ...
    my_address = "0xD57c6a55439A61e8874160502f591bD1bf96DaFe"
    private_key = "7354d112f673e3dbc329479d91b8e97a6b77a327389dd946227a15360a67ccb6"
    print("Connexion to shimmer.network  : ",web3.is_connected())
...
def check_access_Controller_to_switch():
    ...
    my_addresse = "0xE422568F3C95990E5F58BE87B27F0804017b8697"
    private_key = "7354d112f673e3dbc329479d91b8e97a6b77a327389dd946227a15360a67ccb6"
    print("Connection to shimmer.network:", web3.is_connected())
    ...
    x = contract.functions.checkAccess('0x45191aa30986B3207C42102787f14f896AFB5554', '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266').call()
    
    x_1 = contract.functions.checkAccess('0x45191aa30986B3207C42102787f14f896AFB5554','0x73C964F73738931B54686bF02E6Cc774f2Db44e8').call()

    #if topology_1(): 
    print("Get access status between Controller C1 and Switch S3 : ", x_1)
    return x_1
    #elif topology_2():
...
def check_access_Switch_to_switch():
    ...
    z = contract.functions.checkAccess('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266','0xE422568F3C95990E5F58BE87B27F0804017b8697').call()
    z_1 = contract.functions.checkAccess('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266','0x73C964F73738931B54686bF02E6Cc774f2Db44e8').call()
...
def check_access_Controller_to_contoller():
    ...
    y = contract.functions.checkAccessC('0x45191aa30986B3207C42102787f14f896AFB5554','0x18fD9C5C28d0cB57Bb82950dE0ba6d3aB946EA9f').call()
    y_1 = contract.functions.checkAccessC('0x45191aa30986B3207C42102787f14f896AFB5554','0x18fD9C5C28d0cB57Bb82950dE0ba6d3aB946EA9f').call()
